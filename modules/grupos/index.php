<?php
/**
 * Módulo de Grupos - Listado Principal
...
try {
    ...
    $grados_sql = "SELECT DISTINCT gr.id, gr.nombre 
                   FROM grados gr 
                   INNER JOIN grupos g ON gr.id = g.grado_id 
            ...
            <div class="col-12">
                ...
                <div class="page-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="mb-0 mt-2">Gestiona los grupos escolares</p>
                        </div>
                        <div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="stat-card students">
                            ...
                            <h3 class="stat-number"><?php echo count(array_filter($grupos, function($g) { return $g['estado'] === 'activo'; })); ?></h3>
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="stat-card subjects">
                            ...
                            <h3 class="stat-number"><?php echo array_sum(array_column($grupos, 'capacidad')); ?></h3>
                ...
                <div class="content-card">
                    <div class="content-card-header">
                        ...
                        <?php endif; ?>
                        <button class="btn btn-light btn-sm ms-auto" onclick="exportarGrupos()">
                    ...
                    <div class="card-body p-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo $grupo['capacidad'] ?? 'Sin límite'; ?>
                                        </td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            <?php echo date('d/m/Y', strtotime($grupo['fecha_creacion'])); ?>
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                ...
                                                <button type="button" 
                                                        ...
                                                        title="Eliminar"
                                                        onclick="eliminarGrupo(<?php echo $grupo['id']; ?>, '<?php echo htmlspecialchars($grupo['nombre']); ?>')">
                        ...
                        <div class="text-center py-5">
                            ...
                            <a href="agregar.php" class="btn btn-school btn-groups">
                                <i class="fas fa-plus me-2"></i>Agregar Primer Grupo
                            </a>
                        </div>
                        <?php endif; ?>
                    </div>
