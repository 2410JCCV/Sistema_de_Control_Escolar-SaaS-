<?php
/**
 * Editar Horario - Formulario Completo
    ...
    try {
        ...
        if (empty($errors)) {
            try {
                ...
                $update_sql = "
                    UPDATE horarios SET 
                        materia_id = ?, profesor_id = ?, grupo_id = ?, aula_id = ?, 
                ...
                if ($resultado) {
                    ...
                    // Redirigir a la vista del horario con mensaje de éxito
                    $mensaje_url = urlencode($success_message);
                    header("Location: ver.php?id={$horario_id}&success={$mensaje_url}");
                    exit();
                } else {
                    $errors[] = "Error al actualizar el horario en la base de datos";
                }
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div>
                        <a href="ver.php?id=<?php echo $horario_id; ?>" class="btn btn-outline-info me-2">
                ...
                <div class="horario-info">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="mb-1">
                                Horario ID: #<?php echo $horario['id']; ?>
                            </h4>
                            <p class="mb-0">
                                <i class="fas fa-clock me-2"></i>
                                Horario actual: <strong><?php echo ucfirst($horario['dia_semana']); ?> de <?php echo date('H:i', strtotime($horario['hora_inicio'])); ?> a <?php echo date('H:i', strtotime($horario['hora_fin'])); ?></strong>
                            </p>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <form method="POST" id="formEditarHorario" novalidate>
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="ver.php?id=<?php echo $horario_id; ?>" class="btn btn-outline-secondary btn-lg">
