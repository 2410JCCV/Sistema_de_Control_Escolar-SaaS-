<?php
/**
 * Módulo de Horarios - Listado Principal
            ...
            <div class="col-12">
                ...
                <div class="page-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="mb-0 mt-2">Gestiona los horarios de clases</p>
                        </div>
                        <div>
                ...
                <div class="row mb-4">
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="stat-card groups">
                            ...
                            <p class="stat-label">Total Horarios</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="stat-card students">
                            ...
                            <h3 class="stat-number"><?php echo count(array_filter($horarios, function($h) { return $h['estado'] === 'activo'; })); ?></h3>
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="stat-card teachers">
                            ...
                            <h3 class="stat-number"><?php echo count(array_unique(array_column($horarios, 'dia_semana'))); ?></h3>
                            <p class="stat-label">Días con Clases</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="stat-card subjects">
                            ...
                            <h3 class="stat-number"><?php echo count(array_unique(array_column($horarios, 'materia_id'))); ?></h3>
                ...
                <div class="content-card">
                    ...
                    <div class="card-body p-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="search" name="search" 
                                           ...
                                           placeholder="Materia, profesor, grupo o aula">
                                </div>
                            </div>
                            <div class="col-md-3">
                        ...
                        <?php if (!empty($search) || !empty($dia_semana) || !empty($estado)): ?>
                        <div class="mt-3">
                ...
                <div class="content-card">
                    <div class="content-card-header">
                        ...
                        <?php endif; ?>
                        <button class="btn btn-light btn-sm ms-auto" onclick="exportarHorarios()">
                    ...
                    <div class="card-body p-4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-secondary">
                                                <?php echo htmlspecialchars($horario['grupo_nombre'] ?? 'Sin grupo'); ?>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="ver.php?id=<?php echo $horario['id']; ?>" 
                                                   class="btn btn-outline-info btn-sm action-btn" 
                                                   title="Ver detalles">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="editar.php?id=<?php echo $horario['id']; ?>" 
                                                ...
                                                <button type="button" 
                                                        ...
                                                        title="Eliminar"
                                                        onclick="eliminarHorario(<?php echo $horario['id']; ?>, '<?php echo htmlspecialchars($horario['materia_nombre'] ?? 'Sin materia'); ?>')">
                        ...
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-muted">No se encontraron horarios</h5>
                            <p class="text-muted">
                                <?php if (!empty($search) || !empty($dia_semana) || !empty($estado)): ?>
                                No hay horarios que coincidan con los filtros aplicados.
                                <?php else: ?>
                                Aún no hay horarios registrados en el sistema.
                                <?php endif; ?>
                            </p>
