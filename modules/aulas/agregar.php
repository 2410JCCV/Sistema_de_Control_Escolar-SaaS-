<?php
/**
 * Agregar Aula - Formulario Completo
...
// Procesar formulario
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['agregar_aula'])) {
    try {
        ...
        // Verificar que el nombre del aula no exista
        if (empty($errors)) {
            try {
                $pdo = conectarDB();
                
                $stmt = $pdo->prepare("SELECT id FROM aulas WHERE nombre = ?");
                $stmt->execute([$form_data['nombre']]);
                if ($stmt->fetch()) {
        ...
        if (empty($errors)) {
            try {
                ...
                $insert_sql = "
                    INSERT INTO aulas (
                        nombre, ubicacion, capacidad, tipo, estado, fecha_creacion
                    ) VALUES (?, ?, ?, ?, ?, NOW())
                ";
                ...
                if ($resultado) {
                    ...
                    $success_message = "Aula agregada exitosamente";
                    ...
                    $errors[] = "Error al guardar el aula en la base de datos";
                }
    ...
    <div class="container-fluid mt-4">
        <div class="row">
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <form method="POST" id="formAgregarAula" novalidate>
                            <input type="hidden" name="agregar_aula" value="1">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-0">
                                    <i class="fas fa-arrow-right text-primary me-2"></i>
                                    El tipo determina el uso del espacio
                                </p>
                            </div>
                        </div>
                    </div>
