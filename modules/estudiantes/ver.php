...
$page_title = 'Detalles del Estudiante';
            ...
            <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Información detallada del estudiante</p>
                    </div>
                    <div>
                        <a href="index.php" class="btn btn-outline-secondary me-2">
                            <i class="fas fa-arrow-left me-2"></i>Volver a la Lista
                        </a>
                        <a href="editar.php?id=<?php echo $estudiante['id']; ?>" class="btn btn-warning">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0">
                                ...
                                <?php echo htmlspecialchars($estudiante['grupo_nombre'] ?? 'Sin grupo'); ?>
                            </p>
                        </div>
                        <div class="col-md-4 text-end">
                            <div class="stat-item">
                                <div class="stat-value"><?php echo $edad; ?></div>
                                <div>Años de edad</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <?php echo htmlspecialchars($estudiante['apellido_paterno']); ?>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                        <?php echo htmlspecialchars($estudiante['apellido_materno'] ?? 'No especificado'); ?>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <span class="badge bg-<?php echo $estudiante['estado'] == 'activo' ? 'success' : 'secondary'; ?>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <?php echo htmlspecialchars($estudiante['direccion']); ?>
                                        <?php else: ?>
                        ...
                        <div class="card info-card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        <?php echo htmlspecialchars($estudiante['grupo_nombre'] ?? 'No asignado'); ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                        <span class="badge bg-info fs-6">
                                            <?php echo htmlspecialchars($estudiante['matricula']); ?>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <?php echo date('d/m/Y H:i', strtotime($estudiante['fecha_creacion'])); ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-8">
                                        <i class="fas fa-calendar me-1"></i>
                                        <?php echo date('d/m/Y H:i', strtotime($estudiante['fecha_actualizacion'])); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <button type="button" class="btn btn-danger" onclick="eliminarEstudiante(<?php echo $estudiante['id']; ?>, '<?php echo htmlspecialchars($estudiante['nombre'] . ' ' . $estudiante['apellido_paterno']); ?>')">
